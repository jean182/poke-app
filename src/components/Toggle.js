...
const MoonOrSun = styled.div`
  border: ${p => (p.isDark ? "4px" : "2px")} solid #ffde00;
  background: #ffde00;
  border-radius: 50%;
  height: 24px;
  ...
  &::after {
    border-radius: 50%;
    box-shadow: 0 -23px 0 #ffde00, 0 23px 0 #ffde00, 23px 0 0 #ffde00,
      -23px 0 0 #ffde00, 15px 15px 0 #ffde00, -15px 15px 0 #ffde00,
      15px -15px 0 #ffde00, -15px -15px 0 #ffde00;
    content: "";
    height: 8px;
    left: 50%;
    margin: -4px 0 0 -4px;
